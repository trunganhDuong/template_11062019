...
namespace Template_RealEstate_20052019.Database
{
    public class SqlServerDatabase : IDatabase
    {
        ...
        public SqlServerDatabase(IOptions<DbConfig> serverConfig)
        {
            ConnectionString = serverConfig.Value.ConnectionString;
            ConnectDbTimeOut = Convert.ToInt32(serverConfig.Value.Timeout);
        }
